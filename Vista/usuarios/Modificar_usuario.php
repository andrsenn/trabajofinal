<html>
		...
		<body>
			<?php foreach ($usuario as $value){
				$id=$value['id_user'];$nombres=$value['nombres'];$usuario=$value['usuario'];$clave=$value['clave'];;
				}
			?>
			<header>
			...
			<div class="container" id="contenedor"> 
				<center><h3> Modificar Usuario</h3></center> <br>
				<?php $Action="../Controlador/Usuario.php?Usuario=1 & Accion=2" ?>
				<form class="form-horizontal" action="<?php echo $Action; ?>" method="POST">
					<input type="hidden" name="id" value="<?php echo $id;?>">
					<div class="form-group">
					    <label class="col-sm-3 control-label">Nombre del usuario</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" name="nombres"onkeypress="return Letras(event)" required value="<?php echo $nombres;?>">
					    </div>
					</div>
					<div class="form-group">
					    <label class="col-sm-3 control-label">Usuario</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" name="usuario"onkeypress="return Letras(event)" required value="<?php echo $usuario;?>">
					    </div>
					</div>
				  	<div class="form-group">
					    <label class="col-sm-3 control-label">Clave</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" name="clave"required value="<?php echo $clave;?>">
					    </div>
					</div>
